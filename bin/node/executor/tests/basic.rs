...
// NOTE(elsuizo: 2022-08-17): this is a helper constant for the tests
// `deploying_wasm_contract_should_work`
...
// ;;    output_len_ptr: u32
// ;; ) -> u32
// (import "seal0" "seal_call" (func $seal_call (param i32 i32 i64 i32 i32 i32 i32 i32 i32) (result
// i32))) (import "seal0" "seal_input" (func $seal_input (param i32 i32)))
...
// NOTE(elsuizo: 2022-08-17): this test is only when you have in the runtime the pallet contract
// #[test]
