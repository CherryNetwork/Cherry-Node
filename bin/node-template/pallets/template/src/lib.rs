...
//!
//! ### Goals
//! The  Cherrymodule provides functionality for creation and management of storage assets and access management
//! 
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
        ...
        /// submits an on-chain request to fetch data and add it to  cherry
        /// 
...
impl<T: Config> Pallet<T> {
    ...
    /// manage connection to the  cherryipfs swarm
    ///
